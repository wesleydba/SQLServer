...
/****** Object:  StoredProcedure [dbo].[TempDBInfo]    Script Date: 8/25/2023 12:39:18 PM ******/
SET ANSI_NULLS ON
GO
...
create  procedure [dbo].[TempDBInfo]
as
begin
...
*************************************************************************************************************************/
    ...
    insert into #TempDB_Files_SpaceUsage
        (tFileID, tTotal_MB, tAllocated_MB, tUnallocated_MB, tVersionStore_MB, tUserObject_MB, tInternalObject_MB, tMixedExtent_MB)
    select
        [file_id],
