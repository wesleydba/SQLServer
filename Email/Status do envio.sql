--Versão 2 listando qual é a configuração usada no envio 

SELECT c.name as [Configuração Datamail],
...
FROM
    ...
    left join msdb.dbo.sysmail_profile          c on c.profile_id = A.profile_id
where a.sent_status = 1
-- Somente enviado com sucesso
order by 2 desc
---
--Versão 1
