...
-- Last Execution Date Rebuild Job
SELECT top 1 jobs.name AS 'JobName',
msdb.dbo.agent_datetime(run_date, run_time) AS 'Run Date Time',
history.run_duration/60 AS 'Duration in Minute'
FROM msdb.dbo.sysjobs jobs
INNER JOIN msdb.dbo.sysjobhistory history
ON jobs.job_id = history.job_id
WHERE jobs.name = 'Totvs | DBA Cloud - Database Rebuild All Indexes'
order by [Run Date Time] desc


-- Server Configurations
SELECT
     cpu_count CPUQtd,
    physical_memory_kb/1024/1024 MemoryServerGB
