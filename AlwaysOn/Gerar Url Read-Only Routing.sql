--— Read-only routing url generation script. https://olegignat.com/read-only-routing/
...
---fonte  https://web.archive.org/web/20170512023255/https://blogs.msdn.microsoft.com/mattn/2012/04/25/calculating-read_only_routing_url-for-alwayson/
--- https://docs.microsoft.com/pt-br/sql/database-engine/availability-groups/windows/configure-read-only-routing-for-an-availability-group-sql-server?view=sql-server-ver15