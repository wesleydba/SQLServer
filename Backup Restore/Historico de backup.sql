...
End As 'Nvel de Compatibilidade',
    msdb.dbo.backupset.name AS 'Backup Set', msdb.dbo.backupset.user_name , is_copy_only
FROM msdb.dbo.backupmediafamily
    INNER JOIN msdb.dbo.backupset
    ON msdb.dbo.backupmediafamily.media_set_id = msdb.dbo.backupset.media_set_id
WHERE (CONVERT(datetime, msdb.dbo.backupset.backup_start_date, 103) >= GETDATE() - 30) and type = 'D' and database_name = 'DI8L69_HOMOL2'
